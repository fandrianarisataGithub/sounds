 ...
 */
final class Version20210607054941 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE client ADD ca_cumule VARCHAR(255) DEFAULT NULL, ADD nuitee_cumule INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE client DROP ca_cumule, DROP nuitee_cumule');
    }
}
